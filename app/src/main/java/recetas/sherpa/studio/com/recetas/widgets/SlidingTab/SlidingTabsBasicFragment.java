...
public class SlidingTabsBasicFragment extends Fragment {
    ...
    class SamplePagerAdapter extends PagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            if(position == 0)
                return getActivity().getResources().getString(R.string.step_by_step_ingridients);
            else
                return getActivity().getResources().getString(R.string.step_by_step_instructions);
        }
