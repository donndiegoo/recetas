package recetas.sherpa.studio.com.recetas.widgets.FloatingActinButtons;
...
public class FloatingActionsMenu extends ViewGroup {
  ...
  private FloatingActionsMenuButtonListener mListener;
  ...
  public FloatingActionsMenu(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setListener(FloatingActionsMenuButtonListener listener) {
